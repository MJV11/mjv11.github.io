...
const navItems = ['about', 'works', 'bikes', 'contact']
      ...
      <div className='flex flex-row items-center justify-end gap-4 px-5'>
        {navItems.map((item) => (
          <button
            ...
            className={`whitespace-nowrap text-[20px] font-medium cursor-pointer hover:text-[#f3dbc7]
                ...
                ${currentPage === item ? 'text-[#f3dbc7]' : 'text-white'}`}
          >
            {item}
          </button>
        ))}
